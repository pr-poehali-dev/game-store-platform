            ...
            <TooltipTrigger asChild>
              ...
              >
                <Button
                  ...
                  disabled={isLoading}
                  className="bg-[#5865F2] hover:bg-[#4752C4] text-white shadow-2xl w-14 h-14 rounded-full p-0"
                  size="lg"
                >
                  {isLoading ? (
            ...
            <TooltipTrigger asChild>
              ...
              >
                <Button
                  ...
                  className="bg-card border-2 border-[#5865F2]/30 hover:border-[#5865F2] shadow-2xl w-14 h-14 rounded-full p-0 relative overflow-hidden group"
                  size="lg"
                >
                  <img 
                    src={user?.avatar} 
                ...
                <Badge className="absolute -top-1 -left-1 bg-primary text-white text-xs px-1.5">
                  42
                </Badge>
              </motion.div>
            </TooltipTrigger>
