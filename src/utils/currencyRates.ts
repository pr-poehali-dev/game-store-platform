...
// Актуальные курсы на 5 октября 2025 (ЦБ РФ)
const FALLBACK_RATES: ExchangeRates = {
  USD: 82.0,   // Доллар США (ЦБ РФ: 81-82₽)
  EUR: 95.5,   // Евро (ЦБ РФ: 95-96₽)
  CNY: 11.4,   // Китайский юань (ЦБ РФ: 11.3-11.4₽)
  TRY: 2.37,   // Турецкая лира (1 TRY ≈ 2.37 RUB, 41₺ = 1€)
  UAH: 2.0,    // Украинская гривна (1 UAH ≈ 2.0 RUB)
