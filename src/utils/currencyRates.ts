...
const FALLBACK_RATES: ExchangeRates = {
  USD: 96.0,   // Доллар США (октябрь 2024: ~96₽)
  EUR: 105.0,  // Евро (октябрь 2024: ~105₽)
  CNY: 13.5,   // Китайский юань (октябрь 2024: ~13.5₽)
  TRY: 2.84,   // Турецкая лира (октябрь 2024: 1 TRY = 2.84 RUB)
  UAH: 2.35,   // Украинская гривна (октябрь 2024: 1 UAH = 2.35 RUB)
