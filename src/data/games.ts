...
export const initialGames: Game[] = [
  ...
  { id: 20, title: 'Spider-Man 2', platform: 'PlayStation', price: 4499, description: 'Два Человека-паука в одной игре', image_url: 'https://cdn.cloudflare.steamstatic.com/steam/apps/2250590/header.jpg', category: 'Action', rating: 9.4, release_year: 2023, region: 'TR/IN/UA', isNew: true, isHot: true, franchise: 'Spider-Man', fullDescription: 'Питер Паркер и Майлз Моралес объединяются против Венома. Новые способности, враги и невероятный Нью-Йорк.', consoleModels: 'PS5' },
