...
export const initialGames: Game[] = [
  ...
  { id: 45, title: 'Forza Horizon 5', platform: 'Xbox', price: 2999, description: 'Гоночный симулятор в Мексике', image_url: 'https://cdn.cloudflare.steamstatic.com/steam/apps/1551360/header.jpg', category: 'Racing', rating: 9.2, release_year: 2021, discount: 35, franchise: 'Forza', consoleModels: 'Xbox One, Xbox Series X/S', reviewCount: 2, avgReviewRating: 5.0 },
  ...
  { id: 48, title: 'Starfield', platform: 'Xbox', price: 3999, description: 'Космическая RPG Bethesda', image_url: 'https://cdn.cloudflare.steamstatic.com/steam/apps/1716740/header.jpg', category: 'RPG', rating: 8.6, release_year: 2023, discount: 30, isNew: true, consoleModels: 'Xbox Series X/S', reviewCount: 4, avgReviewRating: 4.75 },
