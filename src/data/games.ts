...
export const initialGames: Game[] = [
  { id: 1, title: 'Call of Duty: Modern Warfare III', platform: 'Both', price: 4299, description: 'Легендарный шутер возвращается', image_url: '/img/c7947732-07d6-4968-82aa-c368add510b8.jpg', category: 'Shooter', rating: 8.7, release_year: 2023, isHot: true, isNew: true, franchise: 'Call of Duty', fullDescription: 'Погрузитесь в новую захватывающую кампанию и многопользовательский режим. Знакомые герои, новые угрозы и эпические сражения в легендарной серии шутеров.', consoleModels: 'PS4, PS5, Xbox One, Xbox Series X/S', reviewCount: 4, avgReviewRating: 4.75, developer: 'Infinity Ward', publisher: 'Activision', competitorPrices: [
